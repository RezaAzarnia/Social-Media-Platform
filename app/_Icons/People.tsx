  ...
  return (
    ...
    >
      <path
        fill="#877EFF"
        fillRule="evenodd"
        d="M9 1.25a4.75 4.75 0 100 9.5 4.75 4.75 0 000-9.5zM5.75 6a3.25 3.25 0 116.5 0 3.25 3.25 0 01-6.5 0z"
        clipRule="evenodd"
      ></path>
      <path
        fill="#877EFF"
        d="M15 2.25a.75.75 0 000 1.5 2.25 2.25 0 010 4.5.75.75 0 000 1.5 3.75 3.75 0 100-7.5z"
      ></path>
      <path
        fill="#877EFF"
        fillRule="evenodd"
      ...
      <path
        fill="#877EFF"
        d="M18.16 13.267a.75.75 0 00-.32 1.466c.792.173 1.425.472 1.843.814.418.342.567.677.567.953 0 .25-.12.545-.453.854-.335.311-.85.598-1.513.798a.75.75 0 10.432 1.437c.823-.248 1.558-.631 2.102-1.136.546-.507.932-1.174.932-1.953 0-.865-.474-1.588-1.117-2.114-.644-.527-1.51-.908-2.472-1.119z"
      ></path>
    </svg>
  );
}
